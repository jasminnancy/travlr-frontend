                    ...
                    <Grid>
                        <Grid.Column width={3} verticalAlign='bottom' textAlign='left'>
                            <List divided relaxed>
                                ...
                                <List.Item>
                                    <List.Icon color='black' name='sign in' size='large' /> {props.trip.start_date}
                                </List.Item>
                                <List.Item>
                                    <List.Icon color='black' name='sign out' size='large' /> {props.trip.end_date}
                                </List.Item>
                            </List>
                        </Grid.Column>
                        <Grid.Column width={9}>
                            <Card.Header as='h3'>{props.trip.title}</Card.Header>
                            <Message size='large' className='trip-description'>{props.trip.description}</Message>
                        </Grid.Column>
